...
ActiveRecord::Schema[8.0].define(version: 2025_10_26_000006) do
  ...
  create_table "meal_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["meal_id", "tag_id"], name: "index_meal_tags_on_meal_id_and_tag_id", unique: true
  ...
  create_table "nutrition_goals", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "end_date"], name: "index_nutrition_goals_on_user_id_and_end_date"
    t.index ["user_id", "start_date"], name: "index_nutrition_goals_on_user_id_and_start_date"
  ...
  create_table "user_foods", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "name"], name: "index_user_foods_on_user_id_and_name"
